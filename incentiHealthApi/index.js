...
// @ts-ignore
app.get("/api/proveConsent", async (req, res) => {
	console.log("Consent query request received");
...
app.get("/api/mpesa",async (req,res)=>{
	async function stkPushRequest() {
		try {
		  let headers = new Headers();
		  headers.append("Content-Type", "application/json");
		  headers.append("Authorization", "Bearer BQYG3cuoa6X9xvpGXyKGQoTDsjzS");
		  ...
		  const response = await fetch("https://sandbox.safaricom.co.ke/mpesa/stkpush/v1/processrequest", {
			...
			body: JSON.stringify({
			  ...
			  "Password": "MTc0Mzc5YmZiMjc5ZjlhYTliZGJjZjE1OGU5N2RkNzFhNDY3Y2QyZTBjODkzMDU5YjEwZjc4ZTZiNzJhZGExZWQyYzkxOTIwMjQwOTA3MjM1MjE4",
			  "Timestamp": "20240907235218",
			  "TransactionType": "CustomerPayBillOnline",
			  "Amount": 1,
			  "PartyA": 254708374149,
			  "PartyB": 174379,
			  "PhoneNumber": 254724505428,
...
async function getQueryRequest(req, res) {
	...
	const proofRequest = {
		...
		"query": {
		  ...
		  "context": "ipfs://QmQZ75AmhrGfsAbhUW5yzyh7JGovKoiKpV6YLMNRRaZVWd",
		  "type": "proofOfConsent",
		  "credentialSubject": {
			"consent": {
			  "$eq": true
